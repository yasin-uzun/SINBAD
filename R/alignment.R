...
{
  # setwd(alignment_dir)
  mapq_files = file.path(alignment_dir, list.files(alignment_dir, pattern = '*.mapq_filtered.bam'))
  rmdup_files = file.path(alignment_dir, list.files(alignment_dir, pattern = '*.rmdup.bam'))
  nc_filtered_files = file.path(alignment_dir, list.files(alignment_dir, pattern = '.*.nonCG_filtered.bam$'))
  organism_bam_files = file.path(alignment_dir, list.files(alignment_dir, pattern = '.*.organism.bam$'))
